  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box}
    ...
    .nav-wrap{
      ...
      background:rgba(0,0,0,.32);           /* transparan, tanpa blur biar aman */
      border-bottom:1px solid rgba(255,255,255,.12);
      box-shadow:0 6px 24px rgba(0,0,0,.18);
      backdrop-filter:none;                  /* jangan blur: menghindari garis/banding */
    }
    ...
    .logo{
      ...
      border-radius:10px;                    /* lembut, cocok kebanyakan logo */
      box-shadow:0 6px 16px rgba(0,0,0,.22);
      background:transparent;                /* kalau logomu transparan, tetap bagus */
    }
      ...
      <div class="container">
        <nav class="nav" aria-label="Navigasi utama">
          <a class="brand" href="{{ url('/') }}">
            <!-- PAKAI LOGO GAMBAR KAMU -->
            <img class="logo" src="{{ asset('img/logo-krusit.png') }}" alt="Logo Krusit">
